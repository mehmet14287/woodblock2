...
R.saveGame = function()
{
    if(R.playerData.score < R.score)
    {
        ...
        if(game.device.localStorage) localStorage.setItem('Coolgames_WoodBlocks_PlayerData', JSON.stringify(R.playerData));
    }
};
...
R.loadGame = function()
{
    ...
    {
        let saveData = localStorage.getItem('Coolgames_WoodBlocks_PlayerData');        
